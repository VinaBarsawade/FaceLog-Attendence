...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'vinasbarsawade@coep.sveri.ac.in' ")
...
frame1 = tk.Frame(window, bg="#FFDBAC")
frame1.place(relx=0.11, rely=0.17, relwidth=0.39, relheight=0.80)

frame2 = tk.Frame(window, bg="#FFDBAC")
...
head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="black",bg="#D3D3D3" ,font=('times', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="black",bg="#D3D3D3" ,font=('times', 17, ' bold ') )
head1.place(x=0,y=0)

lbl = tk.Label(frame2, text="Enter ID",width=20  ,height=1  ,fg="black"   ,font=('times', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('times', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="black"   ,font=('times', 17, ' bold '))
...
message = tk.Label(frame2, text=""  ,fg="black"  ,width=39,height=1, activebackground = "yellow" ,font=('times', 16, ' bold '))
message.place(x=7, y=450)

lbl3 = tk.Label(frame1, text="Attendance",width=20  ,fg="black"   ,height=1 ,font=('times', 17, ' bold '))
